...
import 'package:myapp/features/info/presentation/info_view.dart';
import 'package:myapp/features/new_pass/presentation/new_pass_view.dart';

class code2_body extends StatelessWidget {
  const code2_body({super.key});
  @override
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => info_view()),
                  );
                },
                child: Text(
                  "تحقق",
